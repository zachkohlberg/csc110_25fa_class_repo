// PointDemo.java
void main() {
    // making a new object and modifying its variables
    Point p1 = new Point();
    p1.x = 10;
    p1.y = 4.567;

    // making a second object to show that they have their own
    // variables
    Point p2 = new Point();
    p2.x = -11;

    // sharing a mutable reference to remind us what happens
    // when we mutate it
    Point p3 = p1;
    p3.y = 9;
