...
void main() {
    ...
    csc110.credits = 3;
    // assign to a static variable through an instance of Course
    csc110.duration = 7;
    // if we were using a static variable, the right way to access it is:
    // Course.duration = 7;
...
class Course {
    ...
    // example: 3
    int credits;
    // this is not a good idea, just an example of the difference between
    // static and instance variables
    static int duration;
    // try deleting static to see the difference
    ...
    // now that we're overriding toString, we don't need a print method

    // overriding toString to allow easy conversion into a nicely-formatted string
    // the @Override annotation tells the compiler that we're trying to override a
    // method, and it will give us an error if we override it incorrectly
    @Override
    // public is required because the inherited toString is public
